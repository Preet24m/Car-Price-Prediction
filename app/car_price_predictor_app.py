...
@st.cache_resource
def load_model():
    with open(r"/Users/manishgodara/Desktop/CarPricePrediction/CARPRICEPREDICTION/saved_models/RandomForestRegressor.pkl", 'rb') as f:
        model = pickle.load(f)
    with open(r"/Users/manishgodara/Desktop/CarPricePrediction/CARPRICEPREDICTION/saved_scaling/scaler.pkl", 'rb') as f:
